...
router.get('/faculty-workload', authenticate, authorize('admin'), analyticsController.getFacultyWorkload);
router.get('/room-usage-ranking', authenticate, authorize('admin'), analyticsController.getRoomUsageRanking);
